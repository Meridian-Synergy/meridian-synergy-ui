...
import MsSocialLinks from './MsSocialLinks.vue'
...
const meta: Meta<typeof MsSocialLinks> = {
  title: 'Components/MsSocialLinks',
  component: MsSocialLinks,
  tags: ['autodocs'],
  argTypes: {
...
type Story = StoryObj<typeof MsSocialLinks>
