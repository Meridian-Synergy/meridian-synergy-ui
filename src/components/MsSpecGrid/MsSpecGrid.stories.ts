...
import MsSpecGrid from './MsSpecGrid.vue'
...
const meta: Meta<typeof MsSpecGrid> = {
  title: 'Components/MsSpecGrid',
  component: MsSpecGrid,
  tags: ['autodocs'],
}
export default meta

type Story = StoryObj<typeof MsSpecGrid>
