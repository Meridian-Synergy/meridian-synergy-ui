...
import MsValueCard from './MsValueCard.vue'
...
const meta: Meta<typeof MsValueCard> = {
  title: 'Components/MsValueCard',
  component: MsValueCard,
  tags: ['autodocs'],
}
export default meta

type Story = StoryObj<typeof MsValueCard>
